(custom-set-variables
 ...
 '(package-selected-packages
   '(dired-open-with sqlite3 emacsql emacsql-sqlite-builtin osx-dictionary dap-mode svg-tag-mode yaml treesit-auto magit lsp-grammarly ghub company-auctex auctex-lua)))
(custom-set-faces
